          ...
          <div className="flex bg-white/5 p-1 rounded-xl border border-white/10 w-full sm:w-auto overflow-x-auto scrollbar-hide">
            {['1M', '3M', 'YTD', 'All', 'Custom'].map(p => (
              <button 
                ...
                className={`flex-1 sm:flex-initial px-4 py-2 text-[10px] font-black uppercase rounded-lg transition-all ${statsPeriod === p ? 'bg-primary text-black' : 'text-text-muted hover:text-white'} whitespace-nowrap`}
              >
                {p}
              </button>
            ))}
